...
a = Analysis(
    ...
    hiddenimports=['uvicorn.loops.auto', 'uvicorn.loops.asyncio', 'uvicorn.protocols.websockets.auto', 'uvicorn.protocols.http.auto', 'uvicorn.protocols.http.h11_impl', 'uvicorn.protocols.http.httptools_impl', 'uvicorn.lifespan.on', 'fastapi', 'pydantic', 'pydantic_settings', 'openai', 'anthropic', 'httpx', 'loguru', 'jinja2', 'python_multipart', 'mcp', 'mcp.server', 'mcp.types', 'mcp.server.models', 'mcp_server', 'mcp_server.providers', 'mcp_server.managers', 'mcp_server.models', 'mcp_server.utils', 'mcp_server.config', 'mcp_server.processors', 'mcp_server.mcp_server', 'mcp_server.mcp_server.server', 'mcp_server.mcp_server.tools', 'mcp_server.mcp_server.tools.ai_generation', 'mcp_server.mcp_server.tools.vault_operations', 'mcp_server.mcp_server.tools.content_management', 'mcp_server.mcp_server.schemas', 'mcp_server.mcp_server.schemas.mcp_models', 'documize_api', 'documize_api.main'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
